/**
 * Paquete que contiene las clases del modelo (DTOs) de la aplicación Temu.
 */
...
/**
 * DTO para representar una prenda de ropa para hombre.
 */
public class RopaHombreDTO  extends  Ropa 	implements Serializable{
	...
	/**
	 * Crea el DTO con el corte especificado.
	...
	/**
	 * Crea el DTO con todos los atributos.
	...
	/**
	 * Crea el DTO sin especificar el corte.
	 * @param nombre nombre del artículo
	 * @param id identificador único
	 * @param descripcion descripción del artículo
	 * @param precio precio del artículo
